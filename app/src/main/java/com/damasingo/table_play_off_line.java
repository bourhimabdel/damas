...
public class table_play_off_line extends Fragment implements View.OnClickListener {
    ...
    HashMap<Integer, String> brain_pointer_reserve = new HashMap<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       anime_start(new anim_end() {
           ...
           public void oncall_back() {
               mListener.somethingHappenedInFragment("table_created",1);
               click_listner();
               App__conroler();
               brain_pointer_reserve.putAll(brain_pointer);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.l8_c6:
            case R.id.l8_c8:
                move_to_this_place(Principal_view, baida9_to_move, (ImageButton) v);
                break;
        }
    }
    ...
    private void initial_view(View view) {
        Principal_view = view;
        if(getActivity() instanceof local_game_space)
    ...
    private void move_to_this_place(View view, ImageButton piece_to_move, ImageButton place) {
        ...
        if (piece_to_move!=null){
            ...
            Update_the_brain_pointer(place);
    ...
    private void Update_the_brain_pointer(ImageButton place) {
        int the_place = 0;
        switch (place.getId()) {
            case R.id.l1_c1:
                the_place = 1;
        ...
        if((player_1_operation.equals("eat") && player1)||(player_2_operation.equals("eat") && player2))
        {
            ...
            add_to_delete(a);
            //delete_baida9_in_this_place(a);
            if(player1)
                player_1_next_to_eat(the_place);
            else
                player_2_next_to_eat(the_place);
        }
        else if((player_1_operation.equals("move") && player1)||(player_2_operation.equals("move") && player2)) {
            sound.swip_to_move(getContext());
            change_the_role();
        }
...
//
    ...
    private void add_to_delete(int a){
       String name_piece="";
        ...
        for (Map.Entry mapentry : brain_pointer.entrySet()) {
            if ((int)mapentry.getKey() == a) {
                name_piece=mapentry.getValue().toString();
            }
        }
    ...
    private void player_1_next_to_eat(int the_place){
    ...
    private void player_2_next_to_eat(int the_place){
        time_to_eat();
    ...
    private void App__conroler (){
        ...
        if(player1) {
            ...
            if(detect_if_user_2_win()==1){
                mListener.somethingHappenedInFragment("win",1);
            }else
            mListener.somethingHappenedInFragment("role",0);
        }
        else{
            if(!vs_robot) {
            ...
            if(detect_if_user_1_win()==1){
                mListener.somethingHappenedInFragment("win",0);
            }else
            mListener.somethingHappenedInFragment("role",1);
        }
    }
    ...
    public interface Listener_off {
        void somethingHappenedInFragment(String tag,int value);
    }
    private Listener_off mListener;
    ...
    public void go_back(){
        ...
        for (Map.Entry mapentry : brain_pointer_reserve.entrySet()) {
            if (mapentry.getValue() != null) {

                Log.e("b",mapentry.getKey()+"    "+mapentry.getValue());
                ImageView piece = get_this_piece((String) mapentry.getValue());
                baida9_to_move = (ImageButton) get_this_piece((String) mapentry.getValue());
                ImageButton place = null;
                if (piece != null) {
                    switch ((int) mapentry.getKey()) {
                        case 1:
                            place=l1_c1;
                            break;
                        case 2:
                    ...
                    move_to_this_place_(Principal_view, baida9_to_move,place);
                }
            }
        }
    }
    ...
    public ImageView get_this_piece(String player){
        switch (player) {
            case "player1_1":
                return player1_1;
            case "player1_2":
    ...
    private void move_to_this_place_(View view, ImageButton piece_to_move, ImageButton place) {
