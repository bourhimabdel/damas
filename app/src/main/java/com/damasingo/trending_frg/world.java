        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
           /* list_view.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(@NonNull RecyclerView recyclerView, int newState) {
                    ...
                    trending trending  = (com.damasingo.trending) getActivity().getSupportFragmentManager().findFragmentById(R.id.fragment_trending);
                    if (newState==RecyclerView.SCROLL_STATE_IDLE) {
                        if (trending != null) {
                            trending.viewPager.setPagingEnabled(true);
                        }
                    }else if (newState==RecyclerView.SCROLL_STATE_DRAGGING) {
                        if (trending != null) {
                            trending.viewPager.setPagingEnabled(false);
                        }
                    }
                }
            });
    ...
    public void plain_list(){
        if(getActivity()!=null) {
            getActivity().runOnUiThread(() -> {
               ...
               db_online.retrive_gain_day_total(new connect_to_firebase.game_gain_list() {
                   @Override
    ...
    private void click_listner() {
        ...
        btn_top_score.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new Msg_box().show_classment("world",getContext(), (AppCompatActivity) getActivity());
            }
        });
